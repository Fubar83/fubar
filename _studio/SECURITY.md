...
Fubar API Studio is pre-1.0 and moves fast. Security fixes land on `main` and in the
...
Report privately via GitHub's [private vulnerability reporting](https://github.com/Fubar83/Fubar-API-Studio/security/advisories/new)
